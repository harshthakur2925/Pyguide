...
def mains():
    ...
    def search_fn():
        ...
        if "lib" in ch[0]:
            text = scrolledtext.ScrolledText(main,height=8,width=100,bg='black',fg='white',font=('Times New Roman',13),relief='solid',borderwidth=2,state ='normal')
            ...
            if data == "Not Found!!!!":
                ...
                def sp():
                    speak(data)
                bo = Button(main,text='SPEAK',fg='black',bg='lavender',width =10,font=('arial',14,'bold'),bd=1,borderwidth=6,relief='solid',command=sp)
                bo.place(x=1145,y=382)
                lo= Button(main,text="Not Found!!!!",fg='black',bg='lavender',width =67,font=('arial',14,'bold'),bd=1,borderwidth=6,relief='solid',command=None)
                ...
                bo = Button(main,text='SPEAK',fg='black',bg='lavender',width =10,font=('arial',14,'bold'),bd=1,borderwidth=6,relief='solid',command=sp)
                bo.place(x=1145,y=382)
                lo= Button(main,text="Open In Official Website",fg='black',bg='lavender',width =67,font=('arial',14,'bold'),bd=1,borderwidth=6,relief='solid',command=linkopen)
                lo.place(x=345,y=382)
                text.insert(INSERT,data)
                text.config(state= 'disabled')
            ...
            text = scrolledtext.ScrolledText(main,height=25,width=100,bg='black',font=('Times New Roman',13),relief='solid',borderwidth=2)
            def searchgoogle():
                link =[]
                for url in googlesearch.search(query,stop=20):
                    link.append(url)
    ...
    labtxt14 = Label(main,text= '''----Random Python Facts----''',font =('Agency fb',23,'bold'),bg ='white',fg ='black')
    ...
    b1 =Button(main,text='HISTORY',width=8,font=('Arial',12,'bold'),fg='black',bg='lavender',relief='solid',command =ShowView)
    b1.place(x=20,y=610)
    b2 =Button(main,text='ABOUT',width=8,font=('Arial',12,'bold'),fg='black',bg='lavender',relief='solid',command =About)
    b2.place(x=130,y=610)
    b3 =Button(main,text='EXIT',width=8,font=('Arial',12,'bold'),fg='black',bg='lavender',relief='solid',command =Exit)
    b3.place(x=240,y=610)

    b4=Button(main,text='↶',font=('Arial',17,),fg='black',bg='white',bd=1,borderwidth=3,relief='solid',command =Back)
    b4.place(x=440,y=100)
    search = Entry(main,textvariable=SEARCH,font=('arial',24,),width= 34,bg='lavender',borderwidth=5,relief='solid')
    search.place(x=470,y=100)

    try:
        socket.create_connection(('google.com',80))
        b = Button(main,text="SEARCH",width=15,fg="white",bg='black',font=('Franklin Gothic Book',15,"bold"),relief='solid',bd=1,borderwidth=4,command=search_fn)
        b.place(x=900,y=100)

    except:
        b = Button(main, text="SEARCH", width=15, fg="white", bg='black', font=('Franklin Gothic Book', 15, "bold"),relief='solid', bd=1, borderwidth=4, command=None)
        b.place(x=1070, y=100)

    b5=Button(main,text='↺',font=('Arial',17,),fg='black',bg='white',bd=1,borderwidth=3,relief='solid',command =refresh)
